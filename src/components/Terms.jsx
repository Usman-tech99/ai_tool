  ...
  <section className="max-w-4xl mx-auto w-full px-3 sm:px-5 lg:px-8 py-16 sm:py-20">
    ...
    <article className="bg-white border border-gray-200 rounded-2xl p-8 sm:p-12">
      ...
      <div className="prose prose-lg max-w-none text-gray-800 space-y-6">
        ...
        <p className="text-gray-800 leading-relaxed">
          <strong className="text-gray-900">IMPORTANT:</strong> cyberaipulse is provided on an "as-is" basis without warranties of any kind. We do NOT guarantee:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-800 ml-4">
        ...
        <p className="text-gray-800 leading-relaxed mt-4">
          <strong className="text-gray-900">You use cyberaipulse at your own risk.</strong> While we employ industry-standard security practices, no security system is 100% impenetrable.
        </p>
        ...
        <p className="text-gray-800 leading-relaxed">
          cyberaipulse is designed for <strong className="text-gray-900">legitimate security purposes</strong>:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-800 ml-4">
        ...
        <div className="bg-cyan-50 border border-cyan-300 rounded-lg p-4 mt-8 text-cyan-900">
