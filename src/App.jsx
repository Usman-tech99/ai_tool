  ...
  return (
    <div className="min-h-screen w-full bg-[#0a0a0f] text-white overflow-x-hidden">
      ...
      <section className="max-w-6xl mx-auto w-full px-3 sm:px-5 lg:px-8 pt-8 sm:pt-12 lg:pt-16 pb-6 sm:pb-8 text-center">
        <div className="inline-flex flex-wrap justify-center items-center gap-2 bg-violet-600/10 border border-violet-500/20 rounded-full px-3 sm:px-4 py-1.5 text-[10px] sm:text-xs text-violet-300 font-mono uppercase tracking-widest mb-4 sm:mb-6">
        ...
        <p className="text-gray-400 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto px-2">
          ...
          a brute-force attacker — or an <span className="text-violet-300 font-medium">AI neural network</span> — to break yours.
        </p>
      </section>
